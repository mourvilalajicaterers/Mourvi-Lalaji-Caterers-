...
import { Menu, X, Phone, Mail, MapPin, Instagram, Facebook, Twitter, Clock, Users } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-x-hidden">
      ...
      >
        ...
        <span className="absolute right-full mr-4 top-1/2 -translate-y-1/2 bg-charcoal text-white px-4 py-2 rounded-lg text-sm font-bold opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
          Chat with us!
        </span>
      </a>
